...
export function AppSidebar({
  ...
  return (
    <aside
      ...
      className="hidden shrink-0 flex-col overflow-hidden border-r border-border bg-card transition-[width] duration-200 md:flex"
    >
      <div
        className={cn(
      ...
      >
        <Link href="/" aria-label="TraceBack home">
          <TraceBackLogo collapsed={collapsed} />
        </Link>
      </div>
