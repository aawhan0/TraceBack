      ...
      <section className={styles.content}>
        ...
        <div className={styles.page}>
          ...
          <div className={styles.workspace}>
            <section className={styles.controlPanel} aria-label="Investigation controls"><div className={styles.panelHeader}><div><div className={styles.sectionKicker}>CONFIGURATION</div><h2>Investigation setup</h2></div><span className={styles.stepLabel}>01</span></div>
            ...
            <section className={styles.results} aria-live="polite"><div className={styles.panelHeader}><div><div className={styles.sectionKicker}>RESULT</div><h2>Investigation output</h2></div><span className={styles.stepLabel}>02</span></div>
              {!hasRun ? <div className={styles.emptyState}><Sparkles size={20} /><h2>Ready when you are</h2><p>Configure an incident and run the investigation to see the result.</p></div> : <>
                <div className={styles.resultHeader}><div><div className={styles.sectionKicker}>LATEST RUN</div><h2>Root cause diagnosis</h2></div><span className={styles.complete}><span /> Completed</span></div>
